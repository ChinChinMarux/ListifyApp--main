document.addEventListener("DOMContentLoaded", function () {
  ...
  function createTaskElement(task) {
    ...
    if (task.dueDate) {
      ...
      if (isOverdue) {
        dueDateFormatted = `Due: <span class="font-semibold">Overdue</span>`;
        taskEl.classList.add("overdue");
      } else {
        dueDateFormatted = `Due: <span>${dueDate.toLocaleDateString()}</span>`;
      }
    }
            ...
            <div class="flex items-start">
                ...
                <div class="flex-grow">
                    ...
                    <div class="flex flex-wrap items-center mt-2">
                        ...
                        ${
                          task.dueDate
                            ? `<span class="due-date text-xs ml-2 ${
                ...
                <div class="task-actions ml-4 flex space-x-2">
                    ...
                    <button class="delete-task-btn p-1 ${
                      isOverdue
